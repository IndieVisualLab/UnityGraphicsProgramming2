Shader "Custom/Octahedron Sphere Instancing"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2g vert (uint id : SV_VertexID)
			{
				...
				o.pos = float4(_particleBuffer[id].position, 0);
				o.scale = _particleBuffer[id].scale;
				o.level = _particleBuffer[id].level;
				o.rotation = _particleBuffer[id].rotation;
